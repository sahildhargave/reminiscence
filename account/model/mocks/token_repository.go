...
// McokRepository is mock type for model TokenRepository
type MockTokenRepository struct {
	mock.Mock
}

// Set RefreshToken is a mock of model.TokenRepsoitory setrefreshtoken
...
// Deleteing User refresh tokens mocks
